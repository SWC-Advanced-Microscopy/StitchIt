function AddChannels(stitchedDir,channels, offset,range,overwrite,destDir)
% AddChannels(stitchedDir,channels, offset,range,overwrite,destDir)
%
% INPUTS
...
% overwrite	- 1, overwrite; 0, not. Optional, by default 0.
...
fprintf(fid,'Ch%02d + ch%02d + %d',channels(1),channels(2),offset);
