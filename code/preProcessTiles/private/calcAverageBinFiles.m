function calcAverageBinFiles(imStack,tileIndex,thisDirName,illumChans,lowValue)

    % function calcAverageBinFiles(imStack,tileIndex,thisDirName,illumChans,lowValue)
    %
    % Purpose
    % Calculates average tile for a section directory and saves as a "bin" file.
    % This function is called by preProcessTiles
    %
    % Inputs
    % imStack - image stack
